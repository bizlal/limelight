...
contract FERC20 is Context, IERC20, Ownable {
    ...
    function transferFrom(address sender, address recipient, uint256 amount) public override returns (bool) {
        ...
        _approve(sender, _msgSender(), _allowances[sender][_msgSender()].sub(amount, "FERC20: transfer amount exceeds allowance"));

        return true;
    }

    function _approve(address owner, address spender, uint256 amount) private {
        require(owner != address(0), "FERC20: approve from the zero address");
        require(spender != address(0), "FERC20: approve to the zero address");
    ...
    function _transfer(address from, address to, uint256 amount) private {
        require(from != address(0), "FERC20: transfer from the zero address");
        require(to != address(0), "FERC20: transfer to the zero address");
    ...
    function excludeFromMaxTx(address user) public onlyOwner {
        require(user != address(0), "FERC20: Exclude Max Tx from the zero address");
