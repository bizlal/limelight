    ...
    ReentrancyGuardUpgradeable
{
    ...
    function getAmountsOut(
        ...
        if (assetToken_ == assetToken) {
            console.log("assetToken_ == assetToken");
            uint256 newReserveB = reserveB + amountIn;
            console.log("newReserveB: %s", newReserveB);
            uint256 newReserveA = k / newReserveB;
            console.log("newReserveA: %s", newReserveA);
    ...
    function buy(
        ...
        console.log("safeTransferFrom fee ");
