    ...
    GovernorVotesQuorumFractionUpgradeable
{
    ...
    function propose(
        ...
        address contributionNft = IArtistNft(_artistNft).getContributionNft();
        if (
    ...
    function proposalCount()
        public
        view
        override(IArtistDAO, GovernorStorageUpgradeable)
        returns (uint256)
    {
    ...
    function _calcMaturity(
        ...
        address contributionNft = IArtistNft(_artistNft).getContributionNft();
        address serviceNft = IArtistNft(_artistNft).getServiceNft();
        uint256 limelightId = IContributionNft(contributionNft).tokenLimelightId(
            proposalId
        );
        ...
        if (coreService > 0) {
            ...
            maturity = IEloCalculator(IArtistNft(_artistNft).getEloCalculator())
