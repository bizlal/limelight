...
import "@openzeppelin/contracts/token/FERC20/extensions/IERC20Metadata.sol";
import "@openzeppelin/contracts/token/FERC20/IERC20.sol";
import "./IERC20Config.sol";
import "./IErrors.sol";

interface IArtistToken is
    IERC20,
    IERC20Config,
    IERC20Metadata,
    IErrors
{
     ...
     * @param baseParams_ configuration of this FERC20.
     * param supplyParams_ Supply configuration of this FERC20.
     * param taxParams_  Tax configuration of this FERC20
     * param taxParams_  Launch pool configuration of this FERC20
