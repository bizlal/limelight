    ...
    Ownable2StepUpgradeable
{
    ...
    IArtistFactory private _factory; // Single source of truth
    ...
    function initialize(
        ...
        console.log("integrationAddresses_[0]: %s", integrationAddresses_[0]);
        ...
        console.log("vaultSupply: %s", vaultSupply);
        ...
        console.log("swapThresholdBasisPoints: %s", swapThresholdBasisPoints);
        ...
        _factory = IArtistFactory(_msgSender());
     ...
     * required by the EIP. See the note at the beginning of {FERC20}.
     *
     ...
     * accumulated taxes from the contract, with a direct transfer of the FERC20 tokens
     * themselves.
     */
     ...
     * scenario where it might hold an FERC20 is a failed autoswap where the uniswap swap
     ...
     *
     * @param token_ The FERC20 contract
     * @param amount_ The amount to withdraw
     */
     ...
     *
     * See {FERC20-_burn} and {FERC20-allowance}.
     *
     * Requirements:
     *
