    ...
    PausableUpgradeable
{
    ...
    function _executeApplication(
        ...
        console.log("TBA created: %s", tbaAddress);
    ...
    function _createNewArtistToken(
        ...
        console.log("Creating new token by cloning %s", tokenImplementation);
        instance = Clones.clone(tokenImplementation);
        console.log("Initializing token %s", instance);
        console.log("token admin %s, uniswap router %s, asset token %s,", _tokenAdmin, _uniswapRouter, assetToken);
