 ...
 *         - Distributes FERC20 tokens using Merkle-based claims (per-address allocations).
...
contract MerkleBeneficiary is Owned {
    using SafeTransferLib for FERC20;

    // ============ State ============

    /// @notice The FERC20 token being distributed
    FERC20 public immutable token;
    ...
    /**
     * @param _token          FERC20 token address
