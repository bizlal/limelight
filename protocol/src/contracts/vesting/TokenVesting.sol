...
contract TokenVesting is Owned, ReentrancyGuard {
    ...
    // address of the FERC20 token
    FERC20 private immutable _token;
     ...
     * @param token_ address of the FERC20 token contract
     */
    constructor(address token_) Owned(msg.sender) {
        // Check that the token address is not 0x0.
        require(token_ != address(0x0));
        // Set the token address.
        _token = FERC20(token_);
    }
    ...
    /**
     * @dev Returns the address of the FERC20 token managed by the vesting contract.
     */
