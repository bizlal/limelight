...
module.exports = async ({ getNamedAccounts, deployments, getChainId }) => {
  ...
  if (!deployer) {
    throw new Error("Deployer account not found. Please check your namedAccounts configuration.");
  }
  ...
  if (!assetTokenAddress) {
    if (chainId === "84532") {
      log("No existing Asset Token found for base_sepolia. You will deploy a new one.");
    } else {
