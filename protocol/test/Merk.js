...
describe("Merkle + TokenVesting Integration", function () {
  ...
  const rawDistribution =  [
    { address: "0x945757b48f05f9e4e2bd54e25ce801179d79508a", allocation: "1040000" },
    { address: "0x40e15e6c22a94a0df43f1649f60329b6a9125eb6", allocation: "346666" },
    { address: "0xbb80d82d3ce2e7d3d8c0e2969c1b1353946c7ea9", allocation: "333333" },
    { address: "0xadf356802a5a548d0c2ada29f68726b709ed05c7", allocation: "284333" },
    { address: "0x8058f11c5f3f8f330d90c65fdee9c39d40d6ee2d", allocation: "200000" },
    { address: "0x1b82602271df9e355edc5d54476a18b3b1a544fb", allocation: "133333" },
    { address: "0x62032c9edc927a3d8994716a6e2fc433bf74775a", allocation: "100000" },
    { address: "0x01c952174c24e1210d26961d456a77a39e1f0bb0", allocation: "67633" },
    { address: "0xddadff7e0c08332c982d26738979fd619caea6b6", allocation: "66666" },
    { address: "0xae8a89c737e7423def56f6e39bf4052b112d6078", allocation: "66666" },
    { address: "0x5961eb542c0f165cdae601b9cde84ec67d82e6a0", allocation: "66000" },
    { address: "0x70cbfbbff66b4ee208b2975b21b12cca968e1b2b", allocation: "61297" },
    { address: "0xb6b09092a8ffc99aef4c34478ab6847c0f6ebb89", allocation: "60000" },
    { address: "0x5bf9d7cd81b80868201d458702e393341629d723", allocation: "36232" },
    { address: "0x36b31fe2b9d74f2ca067eadc64465f8a692a3d66", allocation: "33333" },
    { address: "0x9515d5b1961b33877388cb1054246523b459432c", allocation: "33333" },
    { address: "0x7caddbd0900cf7cf13cd41ec8a9e36659195f5a4", allocation: "33333" },
    { address: "0x9d8f4a11bb460f2faa0a67eade55ae7a43b94753", allocation: "20626" },
    { address: "0x01afece8c979669248b31de0fdf5479c93fdb903", allocation: "20000" },
    { address: "0x23d4b7547bfbffcfa9908c9203eb34a91051c36a", allocation: "18000" },
    { address: "0xfb4b62cd980a7415c39df889aa1e0016d352aacc", allocation: "16345" },
    { address: "0xd369ec3f2838b23fac1793f848440a56b25ea278", allocation: "13333" },
    { address: "0xe63f0d0888c8269a3193a70d5e0f11b3545b892c", allocation: "10666" },
    { address: "0x458f29275dcc0867f0c106c1049d3e480cc58c04", allocation: "10000" },
    { address: "0x59d09779ee8fa5b20e85858977a0ad3a6500516d", allocation: "7333" },
    { address: "0x80a8241d7421c217be4bcdcc5cc3399aebef96f5", allocation: "6666" },
    { address: "0x66235644e6ca122c4436566656893c8acf024f2a", allocation: "6666" },
    { address: "0x355d3d1db49513b9e05607ae5320b8ef1b4cd232", allocation: "6666" },
    { address: "0xc4138b7158302990f74878c176766031b8a88461", allocation: "6666" },
    { address: "0xa7ad4ca78c3e1e6e45906ba09d8e05e9840d4dee", allocation: "3333" },
    { address: "0x5afaf656937de882c44131245f12baf706a778ec", allocation: "1500" },
    { address: "0x288d2d9b356dfce17db9513204f18e1c3f22b882", allocation: "1333" },
  ];
  ...
  beforeEach(async function () {
    ...
    const MerkleBeneficiary = await ethers.getContractFactory("MerkleBeneficiary");
    const oneDayFromNow = (await ethers.provider.getBlock("latest")).timestamp + 86400;
    merkleBeneficiary = await MerkleBeneficiary.deploy(token.address, merkleRoot, oneDayFromNow);
  ...
  it("Should allow addresses to claim from MerkleBeneficiary only after vesting is released", async function () {
    ...
    // stop impersonation
    await ethers.provider.send("hardhat_stopImpersonatingAccount", [firstAddress]);
    ...
    console.log("MerkleBeneficiary balance after release:", beneficiaryBalance.toString());
    ...
    for (const entry of distributionData) {
      ...
      await ethers.provider.send("hardhat_impersonateAccount", [beneficiaryAddress]);
      ...
      // done
      await ethers.provider.send("hardhat_stopImpersonatingAccount", [beneficiaryAddress]);
    }
  });
});
